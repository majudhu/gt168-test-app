...
//			LibDebugManage.WriteLog2(entryValues[i]);
    ...
    public int DevComm_Init(Activity parentActivity, IUsbConnState usbConnState, Spinner p_spDevice)
    {
        m_nConnected = 0;
        m_nUARTReadLen = 0;
...
//    		return false;
    ...
    public boolean USB_DownImage(byte[] pBuf, int nBufLen)
    {
    	...
    	while (w_nRemainCount > ONCE_UP_IMAGE_UINT)
    	{
    		btCDB[0] = (byte)0xEF; btCDB[1] = 0x17; btCDB[2] = 0; btCDB[3] = (byte)(w_nI & 0xFF);
